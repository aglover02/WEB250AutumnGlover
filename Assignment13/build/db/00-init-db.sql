...
CREATE TABLE IF NOT EXISTS orders (
    ...
    tax DECIMAL(9,6) NOT NULL DEFAULT 0, 
...
CREATE TABLE IF NOT EXISTS login_attempts (
    ...
    cdate TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    mdate TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
